                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/product/findProductById?id=${product.id}'">编辑</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageinfo.pages}" var="pagenum">
                                <li <c:if test="${pagenum==pageinfo.pageNum}">class="active"</c:if> ><a href="${pageContext.request.contextPath}/product/findAll?page=${pagenum}&pageSize=${pageinfo.pageSize}">${pagenum}</a></li>
                            </c:forEach>
